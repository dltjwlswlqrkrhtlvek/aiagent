...
st.write(' - 학습 데이터 출처 : https://www.kaggle.com/code/songulerdem/idao-insomnia-prediction')
...
c = st.number_input(' 몸무게를 입력하세요.', value=0.0 )
                                                            # 사용자가  0,1 중에 선
d = st.selectbox('스트레스 정도를 입력하세요(적음:1, 보통:2,많음3', [1,2,3])
e = st.selectbox('병원 방문 정도를 입력하세요(적음:1, 보통:2,많음3', [1,2,3])
